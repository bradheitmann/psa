...
STORY_NAME="$1"
PROJECT_PATH="${2:-.}"
PSA_EXAMPLES="$HOME/.psa/examples"
CANONICAL_REGISTRY="$HOME/.psa/bloat/canonical-registry.json"
...
echo -e "  Reference in agent briefs: 'See ~/.psa/examples/evidence-bundles/$PROJECT_NAME/$STORY_NAME'"
echo ""

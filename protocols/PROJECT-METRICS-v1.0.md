...
```json
{
  ...
  "projects": [
    {
      "name": "o_bot",
      "displayName": "O Bot - Slack AI Agent",
      "path": "/Users/user/OKOA-Labs/o_bot",
      "github": "https://github.com/user/o_bot",
      "status": "active",
      "type": "web-app",
      "progress": 65,
...
|---------|--------|----------|-----|----------|------------|--------------|
| o_bot | 🟢 Active | 65% | 12.5K | 86% | 1470 L/MT | 2h ago |
| LEVR | 🟢 Active | 42% | 8.2K | 74% | 1250 L/MT | 1d ago |
